...
void __init plat_mem_setup(void)
{
	...
	else if (! strcmp(of_get_flat_dt_prop(of_get_flat_dt_root(), "compatible", NULL), "ubiquiti,ufiber-olt")
		|| ! strncmp(of_get_flat_dt_prop(of_get_flat_dt_root(), "compatible", NULL), "ubiquiti", strlen("ubiquiti"))) {
		int ramsize = get_ramsize();
		if( ! ramsize) {
			ramsize = 256;
		}
