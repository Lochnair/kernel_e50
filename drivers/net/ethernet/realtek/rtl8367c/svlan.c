...
EXPORT_SYMBOL(rtk_svlan_defaultSvlan_set);
...
EXPORT_SYMBOL(rtk_svlan_unmatch_action_set);
...
EXPORT_SYMBOL(rtk_svlan_dmac_vidsel_set);
...
EXPORT_SYMBOL(rtk_svlan_dmac_vidsel_get);
